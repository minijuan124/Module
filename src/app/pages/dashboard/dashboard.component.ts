...
export class DashboardComponent {
  visions: Vision[] = [
    { code: 2, name: 'Visión Gerencial', color: 'primary', url: 'https://app.powerbi.com/groups/me/reports/8aea2590-1119-427c-a673-7e259fc0ac46/0256c5ed82d6eb38de40?experience=power-bi', icon: 'leaderboard' },
    ...
    { code: 8, name: 'Reportes Ad Hoc', color: 'primary', url: 'https://app.powerbi.com/groups/me/reports/8aea2590-1119-427c-a673-7e259fc0ac46/0256c5ed82d6eb38de40?experience=power-bi', icon: 'bar_chart' },
